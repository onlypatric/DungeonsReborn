"""Explicit enums and token coercion for builder v2."""
...
from .internal.normalize import normalize_token, snake_case, suggest_token
...
class ActionType(StrEnum):
    ...
    ATTACH = "attach"
    FOLLOW = "follow"
    LOCK_TO_TARGET = "lock_to_target"
    LOCK_TARGET = "lock_target"
    ANIMATE_REALTIME = "animate_realtime"
    PARTICLES_RING = "particles_ring"
    PARTICLES_POINT = "particles_point"
    PARTICLES_PHYSICS = "particles_physics"
    PARTICLES_PHYSICS_POINTS = "particles_physics_points"
    PARTICLES_PHYSICS_POLYLINE = "particles_physics_polyline"
    PARTICLES_PHYSICS_MESH = "particles_physics_mesh"
    PARTICLES_LINE = "particles_line"
    PARTICLES_ARC = "particles_arc"
    PARTICLES_DISK = "particles_disk"
    PARTICLES_SPHERE_SHELL = "particles_sphere_shell"
    PARTICLES_SPHERE_FILLED = "particles_sphere_filled"
    PARTICLES_HELIX = "particles_helix"
    PARTICLES_BEZIER = "particles_bezier"
    PARTICLES_SPLINE = "particles_spline"
    PARTICLES_POINTS = "particles_points"
    PARTICLES_POLYLINE = "particles_polyline"
    PARTICLES_MESH = "particles_mesh"
    PRESET_SPLINE_MOTION = "preset_spline_motion"
    PARTICLES_CONE = "particles_cone"
    PARTICLES_CYLINDER = "particles_cylinder"
    PARTICLES_BOX = "particles_box"
    PARTICLES_POLYGON = "particles_polygon"
    PRESET_SHOCKWAVE = "preset_shockwave"
    PRESET_MORPH_RING = "preset_morph_ring"
    PRESET_GRADIENT_RING = "preset_gradient_ring"
    PRESET_MORPH_LINE = "preset_morph_line"
    PRESET_GRADIENT_LINE = "preset_gradient_line"
    PRESET_MORPH_ARC = "preset_morph_arc"
    PRESET_GRADIENT_ARC = "preset_gradient_arc"
    PRESET_MORPH_DISK = "preset_morph_disk"
    PRESET_GRADIENT_DISK = "preset_gradient_disk"
    PRESET_MORPH_SPHERE_SHELL = "preset_morph_sphere_shell"
    PRESET_GRADIENT_SPHERE_SHELL = "preset_gradient_sphere_shell"
    PRESET_MORPH_SPHERE_FILLED = "preset_morph_sphere_filled"
    PRESET_GRADIENT_SPHERE_FILLED = "preset_gradient_sphere_filled"
    PRESET_MORPH_HELIX = "preset_morph_helix"
    PRESET_GRADIENT_HELIX = "preset_gradient_helix"
    PRESET_MORPH_CONE = "preset_morph_cone"
    PRESET_GRADIENT_CONE = "preset_gradient_cone"
    PRESET_MORPH_CYLINDER = "preset_morph_cylinder"
    PRESET_GRADIENT_CYLINDER = "preset_gradient_cylinder"
    PRESET_MORPH_BOX = "preset_morph_box"
    PRESET_GRADIENT_BOX = "preset_gradient_box"
    PRESET_MORPH_POLYGON = "preset_morph_polygon"
    PRESET_GRADIENT_POLYGON = "preset_gradient_polygon"
    PRESET_GRADIENT_BEZIER = "preset_gradient_bezier"
    PRESET_GRADIENT_SPLINE = "preset_gradient_spline"
    PRESET_ORBIT = "preset_orbit"
    PRESET_ORBITING_RUNES = "preset_orbiting_runes"
    PRESET_SWIRL = "preset_swirl"
    PRESET_SPIRAL_AURA = "preset_spiral_aura"
    PRESET_BEAM_CHARGEUP = "preset_beam_chargeup"
    CHANCE = "chance"
    DEBUG_LOG = "debug_log"
    RAYCAST_HIT_ENTITY = "raycast_hit_entity"
    FOR_EACH_TARGET = "for_each_target"
    DAMAGE = "damage"
    DAMAGE_TYPED = "damage_typed"
    SET_RESISTANCE = "set_resistance"
    ADD_RESISTANCE = "add_resistance"
    CLEAR_RESISTANCE = "clear_resistance"
    SET_REFLECT = "set_reflect"
    CLEAR_REFLECT = "clear_reflect"
    DAMAGE_PERCENT = "damage_percent"
    DAMAGE_TRUE = "damage_true"
    DAMAGE_FALLOFF = "damage_falloff"
    DAMAGE_CRIT = "damage_crit"
    DAMAGE_LIFESTEAL = "damage_lifesteal"
    ...
    KNOCKBACK = "knockback"
    PULL = "pull"
    AFFLICT_APPLY = "afflict_apply"
    AFFLICT_CLEAR = "afflict_clear"
    AFFLICT_CONSUME = "afflict_consume"
    PROJECTILE = "projectile"
    PROJECTILE_AUTO_AIM_NEAREST = "projectile_auto_aim_nearest"
    PROJECTILE_HOMING_NEAREST = "projectile_homing_nearest"
    MINION_SUMMON = "minion_summon"
    MINIONS = "minions"


class DamagePolicy(StrEnum):
    HOSTILE_DEFAULT = "HOSTILE_DEFAULT"
    FRIENDLY_DEFAULT = "FRIENDLY_DEFAULT"
    ALWAYS = "ALWAYS"
...
class RequirementType(StrEnum):
    ...
    HEALTH_GTE = "health_gte"
    HEALTH_LTE = "health_lte"
    HEALTH_PCT_GTE = "health_pct_gte"
    HEALTH_PCT_LTE = "health_pct_lte"
...
class ConditionType(StrEnum):
    ...
    PERMISSION = "permission"
    HAS_ITEM_TAG = "has_item_tag"
    CASTER_HAS_TAG = "caster_has_tag"
    HAS_TAG = "has_tag"
    CASTER_LACKS_TAG = "caster_lacks_tag"
    LACKS_TAG = "lacks_tag"
    ...
    REGION = "region"
    IN_PARTY = "in_party"
    PARTY_SIZE_GTE = "party_size_gte"
    PARTY_SIZE_LTE = "party_size_lte"
    ...
    MANA_GTE = "mana_gte"
    MANA_LTE = "mana_lte"
    MANA_PCT_GTE = "mana_pct_gte"
    MANA_PCT_LTE = "mana_pct_lte"
    LEVEL_GTE = "level_gte"
    LEVEL_LTE = "level_lte"
    XP_GTE = "xp_gte"
    XP_LTE = "xp_lte"
    ...
    VAR_GT = "var_gt"
    VAR_LT = "var_lt"
    AFFLICT_PRESENT = "afflict_present"
    AFFLICT_STACKS_GTE = "afflict_stacks_gte"
    AFFLICT_STACKS_LTE = "afflict_stacks_lte"
    AFFLICT_REMAINING_LTE = "afflict_remaining_lte"
    NOT = "not"
    AND = "and"
    OR = "or"
...
class CombatEventType(StrEnum):
    ON_ATTACK_ATTEMPT = "ON_ATTACK_ATTEMPT"
    ON_ATTACK_HIT = "ON_ATTACK_HIT"
    ON_ATTACK_CRIT = "ON_ATTACK_CRIT"
    ON_ATTACK_KILL = "ON_ATTACK_KILL"
    ON_HIT_TAKEN = "ON_HIT_TAKEN"
    ON_BLOCK = "ON_BLOCK"
    ON_PARRY = "ON_PARRY"
    ON_DODGE = "ON_DODGE"
    ON_PROJECTILE_HIT_ENTITY = "ON_PROJECTILE_HIT_ENTITY"
    ON_PROJECTILE_HIT_BLOCK = "ON_PROJECTILE_HIT_BLOCK"
    ON_PROJECTILE_LAUNCH_PRE = "ON_PROJECTILE_LAUNCH_PRE"
    ON_PROJECTILE_LAUNCH = "ON_PROJECTILE_LAUNCH"
    ON_PROJECTILE_TRAVEL_STEP = "ON_PROJECTILE_TRAVEL_STEP"
    ON_PROJECTILE_COLLIDE_ENTITY_PRE = "ON_PROJECTILE_COLLIDE_ENTITY_PRE"
    ON_PROJECTILE_COLLIDE_BLOCK_PRE = "ON_PROJECTILE_COLLIDE_BLOCK_PRE"
    ON_PROJECTILE_PIERCE = "ON_PROJECTILE_PIERCE"
    ON_PROJECTILE_BOUNCE = "ON_PROJECTILE_BOUNCE"
    ON_PROJECTILE_STUCK = "ON_PROJECTILE_STUCK"
    ON_PROJECTILE_EXPIRE = "ON_PROJECTILE_EXPIRE"
    ON_PROJECTILE_DEFLECT = "ON_PROJECTILE_DEFLECT"
    ON_PROJECTILE_BLOCKED_SHIELD = "ON_PROJECTILE_BLOCKED_SHIELD"
    ON_PROJECTILE_CANCELLED = "ON_PROJECTILE_CANCELLED"
    ON_DOT_APPLY = "ON_DOT_APPLY"
    ON_DOT_TICK = "ON_DOT_TICK"
    ON_DOT_EXPIRE = "ON_DOT_EXPIRE"
    ON_CC_APPLY = "ON_CC_APPLY"
    ON_CC_EXPIRE = "ON_CC_EXPIRE"
    ON_EXECUTE_THRESHOLD = "ON_EXECUTE_THRESHOLD"


class CombatCooldownScope(StrEnum):
    PER_PLAYER = "PER_PLAYER"
    PER_TARGET = "PER_TARGET"
    PER_ABILITY = "PER_ABILITY"


class CombatEventTargetBind(StrEnum):
    ATTACKER = "attacker"
    VICTIM = "victim"
...
class CombatEventOriginBind(StrEnum):
    IMPACT = "impact"
    ATTACKER = "attacker"
    VICTIM = "victim"
    EVENT_PRIMARY = "event_primary"
...
class ProjectileFamily(StrEnum):
    VANILLA = "VANILLA"
    CUSTOM = "CUSTOM"
...
class ParticlePhysicsCollisionMode(StrEnum):
    STOP = "STOP"
    BOUNCE = "BOUNCE"
    PASS_THROUGH = "PASS_THROUGH"


class PotionEffect(StrEnum):
...
class TargeterType(StrEnum):
    ...
    SPHERE = "sphere"
    NEAREST = "nearest"
    NEAREST_WITHIN_ANGLE = "nearest_within_angle"
    CONE = "cone"
    LINE_OF_SIGHT = "line_of_sight"
    GROUND_SPHERE = "ground_sphere"
    GROUND_SNAP = "ground_snap"
    BOX = "box"
    CYLINDER = "cylinder"
    CAPSULE_RAY = "capsule_ray"
    CHAIN = "chain"
    RANDOM = "random"
    RANDOM_N = "random_n"
...
class CraftingMatchType(StrEnum):
    ITEM_ID = "item_id"
...
class CraftingItemCategory(StrEnum):
    ANY = "any"
    WEAPON = "weapon"
    RANGED = "ranged"
    TOOL = "tool"
...
class CraftingCostType(StrEnum):
    MANA = "mana"
    RESOURCE = "resource"
    TOKENS = "tokens"
    DURABILITY = "durability"
...
class CraftingRequirementType(StrEnum):
    PERMISSION = "permission"
    LEVEL = "level"
    CUSTOM_XP = "custom_xp"
    QUEST = "quest"
...
class ShopIngredientType(StrEnum):
    TOKEN = "token"
    ITEM_ID = "item_id"
    MATERIAL = "material"
    ITEMSTACK = "itemstack"
...
class ClassAbilityTrigger(StrEnum):
    PASSIVE = "PASSIVE"
    LEFT_CLICK = "LEFT_CLICK"
    RIGHT_CLICK = "RIGHT_CLICK"
    ON_HIT = "ON_HIT"
...
class ClassScalingMode(StrEnum):
    FLAT = "FLAT"
    PER_RANK = "PER_RANK"
    PERCENT = "PERCENT"
    CURVE = "CURVE"
...
class ClassScalingCurve(StrEnum):
    LINEAR = "LINEAR"
    QUAD = "QUAD"
    CUBIC = "CUBIC"
    SQRT = "SQRT"
...
class AfflictionRefreshPolicy(StrEnum):
...
class AfflictionAudience(StrEnum):
    ANY = "ANY"
    PVE_ONLY = "PVE_ONLY"
    PVP_ONLY = "PVP_ONLY"
...
class MobAiMode(StrEnum):
    DEFAULT = "DEFAULT"
    FULL_OVERRIDE = "FULL_OVERRIDE"


class MobAiAuthority(StrEnum):
    VANILLA = "VANILLA"
    ABILITY_DRIVEN = "ABILITY_DRIVEN"


class MobAiIntentType(StrEnum):
    CHASE = "CHASE"
    FLEE = "FLEE"
    ...
    ASSIST = "ASSIST"
    CALL_HELP = "CALL_HELP"
    CHASE_AND_CAST = "CHASE_AND_CAST"
    CAST_ONLY = "CAST_ONLY"


class MobAiRuntimeModel(StrEnum):
    LEGACY_V4 = "LEGACY_V4"
    NATURAL_V1 = "NATURAL_V1"


class MobAiMovementPolicy(StrEnum):
    PATHFINDER_FIRST = "PATHFINDER_FIRST"
    HYBRID_INTENT = "HYBRID_INTENT"
    VELOCITY_ONLY = "VELOCITY_ONLY"


class MobAiTargetSourceType(StrEnum):
    LAST_ATTACKER = "LAST_ATTACKER"
    PROXIMITY_PLAYER = "PROXIMITY_PLAYER"
    PROXIMITY_HOSTILE = "PROXIMITY_HOSTILE"
    CURRENT_TARGET = "CURRENT_TARGET"


class MobTier(StrEnum):
    P01 = "P01"
    P01_ELITE = "P01_ELITE"
    P01_BOSS = "P01_BOSS"
    P01_PASSIVE = "P01_PASSIVE"


class MobSoundProfile(StrEnum):
    GHOST = "ghost"
    UNDEAD = "undead"


class PassiveSlot(StrEnum):
    MAIN_HAND = "MAIN_HAND"
    OFF_HAND = "OFF_HAND"
    HEAD = "HEAD"
    CHEST = "CHEST"
...
class UpgradeActivator(StrEnum):
    RIGHT_CLICK = "RIGHT_CLICK"
    LEFT_CLICK = "LEFT_CLICK"
...
TokenFamily = Literal["material", "entity", "sound", "particle", "potion_effect", "projectile_kind", "mob_tier"]
...
MaterialLike = Material | CustomToken
EntityTypeLike = EntityType | CustomToken
SoundLike = Sound | CustomToken
ParticleLike = Particle | CustomToken
PotionEffectLike = PotionEffect | CustomToken
ItemUseAnimationLike = ItemUseAnimation
DamagePolicyLike = DamagePolicy | CustomToken
EasingLike = Easing
AtModeLike = AtMode
AnchorModeLike = AnchorMode
AnchorPointLike = AnchorPoint
MotionModeLike = MotionMode
RequirementTypeLike = RequirementType
CostTypeLike = CostType
ConditionTypeLike = ConditionType
ActionTypeLike = ActionType
CombatEventTypeLike = CombatEventType | CustomToken
CombatCooldownScopeLike = CombatCooldownScope | CustomToken
CombatEventTargetBindLike = CombatEventTargetBind | CustomToken
CombatEventOriginBindLike = CombatEventOriginBind | CustomToken
ProjectileFamilyLike = ProjectileFamily | CustomToken
ProjectileKindLike = ProjectileKind | CustomToken
ParticlePhysicsCollisionModeLike = ParticlePhysicsCollisionMode
MobAiModeLike = MobAiMode
MobAiAuthorityLike = MobAiAuthority
MobAiIntentTypeLike = MobAiIntentType
MobAiRuntimeModelLike = MobAiRuntimeModel
MobAiMovementPolicyLike = MobAiMovementPolicy
MobAiTargetSourceTypeLike = MobAiTargetSourceType
MobTierLike = MobTier | CustomToken
CraftingMatchTypeLike = CraftingMatchType
CraftingItemCategoryLike = CraftingItemCategory
CraftingCostTypeLike = CraftingCostType
CraftingRequirementTypeLike = CraftingRequirementType
ShopIngredientTypeLike = ShopIngredientType
QuestObjectiveTypeLike = QuestObjectiveType
ClassNodeTypeLike = ClassNodeType
ClassAbilityTriggerLike = ClassAbilityTrigger
ClassScalingModeLike = ClassScalingMode
ClassScalingCurveLike = ClassScalingCurve
AttributeOperationLike = AttributeOperation
DamageTypeLike = DamageType
DamageCauseLike = DamageCause
HealTypeLike = HealType
AfflictionRefreshPolicyLike = AfflictionRefreshPolicy
AfflictionAudienceLike = AfflictionAudience
UpgradeRarityLike = UpgradeRarity
UpgradeActivatorLike = UpgradeActivator


_T = TypeVar("_T", bound=StrEnum)


def custom_material(value: str) -> CustomToken:
    return CustomToken("material", _normalize_custom(value, "material"))


def custom_entity(value: str) -> CustomToken:
    return CustomToken("entity", _normalize_custom(value, "entity"))


def custom_sound(value: str) -> CustomToken:
    return CustomToken("sound", _normalize_custom(value, "sound"))


def custom_particle(value: str) -> CustomToken:
    return CustomToken("particle", _normalize_custom(value, "particle"))


def custom_potion_effect(value: str) -> CustomToken:
    return CustomToken("potion_effect", _normalize_custom(value, "potion_effect"))


def custom_projectile_kind(value: str) -> CustomToken:
    token = snake_case(value)
    if not token:
        raise ValueError("custom_projectile_kind: token cannot be empty")
    return CustomToken("projectile_kind", token)


def custom_mob_tier(value: str) -> CustomToken:
    token = str(value).strip().upper()
    if not token:
        raise ValueError("custom_mob_tier: token cannot be empty")
    return CustomToken("mob_tier", token)


def coerce_enum(value: _T | CustomToken | str, enum_cls: type[_T], *, field: str, family: TokenFamily | None = None) -> str:
    if isinstance(value, enum_cls):
        return value.value
    if isinstance(value, CustomToken):
        if family is not None and value.family != family:
            raise ValueError(f"{field}: token family mismatch; expected {family}, got {value.family}")
        return value.value
    if isinstance(value, str):
        expected = ", ".join(entry.value for entry in enum_cls)
        custom_hint = f" or custom_{family}(...)" if family is not None else ""
        raise ValueError(
            f"{field}: plain string tokens are forbidden in typed APIs. "
            f"Use {enum_cls.__name__} enum{custom_hint}. Expected one of [{expected}]"
        )
    raise ValueError(f"{field}: unsupported value type={type(value).__name__}")


def coerce_enum_with_aliases(
    value: _T | str,
    enum_cls: type[_T],
    *,
    field: str,
    ...
    if isinstance(value, str):
        ...
        raise ValueError(
            f"{field}: plain string tokens are forbidden in typed APIs. "
            f"Use {enum_cls.__name__} enum. Expected one of [{expected}]"
        )
    raise ValueError(f"{field}: unsupported value type={type(value).__name__}")


def coerce_material(value: MaterialLike | str, *, field: str) -> str:
    return coerce_enum(value, Material, field=field, family="material")


def coerce_entity_type(value: EntityTypeLike | str, *, field: str) -> str:
    return coerce_enum(value, EntityType, field=field, family="entity")


def coerce_sound(value: SoundLike | str, *, field: str) -> str:
    return coerce_enum(value, Sound, field=field, family="sound")


def coerce_particle(value: ParticleLike | str, *, field: str) -> str:
    return coerce_enum(value, Particle, field=field, family="particle")


def coerce_potion_effect(value: PotionEffectLike | str, *, field: str) -> str:
    return coerce_enum(value, PotionEffect, field=field, family="potion_effect")


def coerce_item_use_animation(value: ItemUseAnimationLike | str, *, field: str) -> str:
    return coerce_enum(value, ItemUseAnimation, field=field)


def coerce_damage_policy(value: DamagePolicyLike | str, *, field: str) -> str:
    return coerce_enum(value, DamagePolicy, field=field)


def coerce_requirement_type(value: RequirementTypeLike | str, *, field: str) -> str:
    return coerce_enum(value, RequirementType, field=field)


def coerce_cost_type(value: CostTypeLike | str, *, field: str) -> str:
    return coerce_enum(value, CostType, field=field)


def coerce_condition_type(value: ConditionTypeLike | str, *, field: str) -> str:
    return coerce_enum(value, ConditionType, field=field)


def coerce_action_type(value: ActionTypeLike | str, *, field: str) -> str:
    return coerce_enum(value, ActionType, field=field)


def coerce_combat_event_type(value: CombatEventTypeLike | str, *, field: str) -> str:
    return coerce_enum(value, CombatEventType, field=field)


def coerce_combat_cooldown_scope(value: CombatCooldownScopeLike | str, *, field: str) -> str:
    return coerce_enum(value, CombatCooldownScope, field=field)


def coerce_combat_target_bind(value: CombatEventTargetBindLike | str, *, field: str) -> str:
    return coerce_enum(value, CombatEventTargetBind, field=field)


def coerce_combat_origin_bind(value: CombatEventOriginBindLike | str, *, field: str) -> str:
    return coerce_enum(value, CombatEventOriginBind, field=field)


def coerce_projectile_family(value: ProjectileFamilyLike | str, *, field: str) -> str:
    return coerce_enum(value, ProjectileFamily, field=field)


def coerce_projectile_kind(value: ProjectileKindLike | str, *, field: str) -> str:
    return coerce_enum(value, ProjectileKind, field=field, family="projectile_kind")


def coerce_particle_physics_collision_mode(value: ParticlePhysicsCollisionModeLike | str, *, field: str) -> str:
    aliases = {
        "PASS-THROUGH": "PASS_THROUGH",
        "PASSTHROUGH": "PASS_THROUGH",
    }
    return coerce_enum_with_aliases(value, ParticlePhysicsCollisionMode, field=field, aliases=aliases)


def coerce_easing(value: EasingLike | str, *, field: str) -> str:
    return coerce_enum(value, Easing, field=field)


def coerce_at_mode(value: AtModeLike | str, *, field: str) -> str:
    aliases = {
        "LAST-HIT": "LAST_HIT",
        "LASTHIT": "LAST_HIT",
        "LAST-ENTITY": "LAST_ENTITY",
        "LASTENTITY": "LAST_ENTITY",
    }
    return coerce_enum_with_aliases(value, AtMode, field=field, aliases=aliases)


def coerce_anchor_mode(value: AnchorModeLike | str, *, field: str) -> str:
    aliases = {
        "SELF": "CASTER",
        "TARGET": "LAST_ENTITY",
        "LAST-ENTITY": "LAST_ENTITY",
    ...
    return coerce_enum_with_aliases(value, AnchorMode, field=field, aliases=aliases)


def coerce_anchor_point(value: AnchorPointLike | str | None, *, field: str) -> str | None:
    if value is None:
        return None
    aliases = {
        "EYE": "EYES",
    ...
    return coerce_enum_with_aliases(value, AnchorPoint, field=field, aliases=aliases)


def coerce_motion_mode(value: MotionModeLike | str, *, field: str) -> str:
    return coerce_enum(value, MotionMode, field=field)


def coerce_targeter_type(value: TargeterType | str, *, field: str) -> str:
    aliases = {
        "CONTEXT_TARGET": "CONTEXT_TARGET",
        ...
        "LOOK-RAY": "LOOK_RAY",
        "NEAREST_WITHIN_ANGLE": "NEAREST_WITHIN_ANGLE",
        "NEAREST-WITHIN-ANGLE": "NEAREST_WITHIN_ANGLE",
        "NEAREST_ANGLE": "NEAREST_WITHIN_ANGLE",
        "NEAREST-ANGLE": "NEAREST_WITHIN_ANGLE",
        "LINE_OF_SIGHT": "LINE_OF_SIGHT",
        "LINE-OF-SIGHT": "LINE_OF_SIGHT",
        "LOS": "LINE_OF_SIGHT",
        "GROUND_SPHERE": "GROUND_SPHERE",
        "GROUND-SPHERE": "GROUND_SPHERE",
        "GROUND_SNAP": "GROUND_SNAP",
        "GROUND-SNAP": "GROUND_SNAP",
        "CAPSULE_RAY": "CAPSULE_RAY",
        "CAPSULE-RAY": "CAPSULE_RAY",
        "RANDOM_N": "RANDOM_N",
        "RANDOM-N": "RANDOM_N",
        "WEIGHTED_DISTANCE": "WEIGHTED_DISTANCE",
        "WEIGHTED-DISTANCE": "WEIGHTED_DISTANCE",
        "WEIGHTED_THREAT": "WEIGHTED_THREAT",
        "WEIGHTED-THREAT": "WEIGHTED_THREAT",
    }
    return coerce_enum_with_aliases(value, TargeterType, field=field, aliases=aliases)


def coerce_crafting_match_type(value: CraftingMatchTypeLike | str, *, field: str) -> str:
    return coerce_enum(value, CraftingMatchType, field=field)


def coerce_crafting_item_category(value: CraftingItemCategoryLike | str, *, field: str) -> str:
    return coerce_enum(value, CraftingItemCategory, field=field)


def coerce_crafting_cost_type(value: CraftingCostTypeLike | str, *, field: str) -> str:
    return coerce_enum(value, CraftingCostType, field=field)


def coerce_crafting_requirement_type(value: CraftingRequirementTypeLike | str, *, field: str) -> str:
    return coerce_enum(value, CraftingRequirementType, field=field)


def coerce_shop_ingredient_type(value: ShopIngredientTypeLike | str, *, field: str) -> str:
    aliases = {
        "TOKENS": "TOKEN",
        "ITEM": "ITEM_ID",
        "ITEMID": "ITEM_ID",
    ...
    return coerce_enum_with_aliases(value, ShopIngredientType, field=field, aliases=aliases)


def coerce_quest_objective_type(value: QuestObjectiveTypeLike | str, *, field: str) -> str:
    aliases = {
        "KILL": "KILL_MOB",
        "CRAFT": "CRAFT_ITEM",
        "COLLECT_ITEM": "USE_ITEM",
        "PLACE": "PLACE_BLOCK",
        "BREAK": "BREAK_BLOCK",
        "VISIT": "VISIT_REGION",
    }
    return coerce_enum_with_aliases(value, QuestObjectiveType, field=field, aliases=aliases)


def coerce_class_node_type(value: ClassNodeTypeLike | str, *, field: str) -> str:
    return coerce_enum(value, ClassNodeType, field=field)


def coerce_class_ability_trigger(value: ClassAbilityTriggerLike | str, *, field: str) -> str:
    aliases = {
        "LEFT": "LEFT_CLICK",
        "RIGHT": "RIGHT_CLICK",
        "HIT": "ON_HIT",
    ...
    return coerce_enum_with_aliases(value, ClassAbilityTrigger, field=field, aliases=aliases)


def coerce_class_scaling_mode(value: ClassScalingModeLike | str, *, field: str) -> str:
    aliases = {
        "PER_LEVEL": "PER_RANK",
        "PER_TIER": "PER_RANK",
        "LINEAR": "PER_RANK",
        "PCT": "PERCENT",
        "PERCENT_PER_RANK": "PERCENT",
        "CURVED": "CURVE",
    }
    return coerce_enum_with_aliases(value, ClassScalingMode, field=field, aliases=aliases)


def coerce_class_scaling_curve(value: ClassScalingCurveLike | str, *, field: str) -> str:
    aliases = {
        "QUADRATIC": "QUAD",
        "SQUARE_ROOT": "SQRT",
        "LOGARITHMIC": "LOG",
    ...
    return coerce_enum_with_aliases(value, ClassScalingCurve, field=field, aliases=aliases)


def coerce_attribute_operation(value: AttributeOperationLike | str, *, field: str) -> str:
    return coerce_enum(value, AttributeOperation, field=field)


def coerce_damage_type(value: DamageTypeLike | str, *, field: str) -> str:
    return coerce_enum(value, DamageType, field=field)


def coerce_damage_cause(value: DamageCauseLike | str, *, field: str) -> str:
    aliases = {
    ...
    return coerce_enum_with_aliases(value, DamageCause, field=field, aliases=aliases)


def coerce_heal_type(value: HealTypeLike | str, *, field: str) -> str:
    aliases = {
        "HEAL": "DIRECT",
        "HEAL_OVER_TIME": "HOT",
        "HEAL_HOT": "HOT",
    ...
    return coerce_enum_with_aliases(value, HealType, field=field, aliases=aliases)


def coerce_affliction_refresh_policy(value: AfflictionRefreshPolicyLike | str, *, field: str) -> str:
    aliases = {
    ...
    return coerce_enum_with_aliases(value, AfflictionRefreshPolicy, field=field, aliases=aliases)


def coerce_affliction_audience(value: AfflictionAudienceLike | str, *, field: str) -> str:
    aliases = {
        "PVE": "PVE_ONLY",
        "PVP": "PVP_ONLY",
    }
    return coerce_enum_with_aliases(value, AfflictionAudience, field=field, aliases=aliases)


def coerce_upgrade_rarity(value: UpgradeRarityLike | str, *, field: str) -> str:
    return coerce_enum(value, UpgradeRarity, field=field)


def coerce_upgrade_activator(value: UpgradeActivatorLike | str, *, field: str) -> str:
    aliases = {
        "SHIFT_RIGHT": "SHIFT_RIGHT_CLICK",
        "SHIFT_LEFT": "SHIFT_LEFT_CLICK",
    }
    return coerce_enum_with_aliases(value, UpgradeActivator, field=field, aliases=aliases)


def coerce_mob_ai_mode(value: MobAiModeLike | str, *, field: str) -> str:
    return coerce_enum(value, MobAiMode, field=field)


def coerce_mob_ai_authority(value: MobAiAuthorityLike | str, *, field: str) -> str:
    return coerce_enum(value, MobAiAuthority, field=field)


def coerce_mob_ai_intent_type(value: MobAiIntentTypeLike | str, *, field: str) -> str:
    return coerce_enum(value, MobAiIntentType, field=field)


def coerce_mob_ai_runtime_model(value: MobAiRuntimeModelLike | str, *, field: str) -> str:
    return coerce_enum(value, MobAiRuntimeModel, field=field)


def coerce_mob_ai_movement_policy(value: MobAiMovementPolicyLike | str, *, field: str) -> str:
    return coerce_enum(value, MobAiMovementPolicy, field=field)


def coerce_mob_ai_target_source_type(value: MobAiTargetSourceTypeLike | str, *, field: str) -> str:
    return coerce_enum(value, MobAiTargetSourceType, field=field)


def coerce_mob_tier(value: MobTierLike | str, *, field: str) -> str:
    return coerce_enum(value, MobTier, field=field, family="mob_tier")


def coerce_literal(value: str, options: Iterable[str], *, field: str) -> str:
    raw = str(value).strip()
    if raw in options:
        return raw
    suggestions = suggest_token(list(options), raw)
    hint = f" Did you mean: {', '.join(suggestions)}?" if suggestions else ""
    raise ValueError(f"{field}: invalid value={value!r}. Expected one of {list(options)!r}.{hint}")


def _normalize_custom(value: str, family: str) -> str:
    token = normalize_token(value)
    if not token:
        raise ValueError(f"custom_{family}: token cannot be empty")
    return token
...
__all__ = [
    ...
    "CraftingItemCategoryLike",
    "CraftingCostTypeLike",
    "CraftingRequirementTypeLike",
    "ShopIngredientTypeLike",
    "QuestObjectiveTypeLike",
    "ClassNodeTypeLike",
    ...
    "coerce_anchor_point",
    "coerce_motion_mode",
    "coerce_targeter_type",
    "coerce_crafting_match_type",
    "coerce_crafting_item_category",
    "coerce_crafting_cost_type",
    "coerce_crafting_requirement_type",
    "coerce_shop_ingredient_type",
    "coerce_quest_objective_type",
